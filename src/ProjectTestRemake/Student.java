...
class Student extends School{
	int grade, group, studentCnt, size = 1, studentNum;
	...
	public void StudentAdd(int studentGrade, int studentGroup, String studentName) {
		...
		studentArr[studentNum] = studentName;
	...
	public void studentDel(String studentName) {
		...
		for(int i = j; i < studentArr.length-1; i++) {
	...
	public void studentDel(int grade, int group, int number) {
		...
		System.out.println(studentArr.length);
		for(i = studentNum; i < studentArr.length; i++) {
			studentArr[i] = studentArr[i+1];
		}
		String newArr[] = new String[size-1];
		for (i = 0; i < size; i++) {
	...
	public boolean match(int grade, int group, int number) {
		for(int i = 0; i < gradeClassNumber.length; i++) {
